...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', default="248-hand", help="model name: Context Guided Network (CGNet)")
    parser.add_argument('--model', default="handnet", help="model name: Hierarchically Aggregated Narrow Dilated Network (HANDNet)")
    ...
    parser.add_argument('--max_epochs', type=int, default=1, help="the number of epochs: 300 for train set, 350 for train+val set")
