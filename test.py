...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default="handnet", help="model name ")
    ...
    # if '--best' is provided, it means best is True. If it is absent, it means it is False.
    # NOTE: Here, it only gets defined. It presence or absence while giving test.py command will determine the outcome.
    # For example: if I give the command "python test.py --best", it means I want the evaluation of last 10 models and then finding the best
    # Similarly, if I give the command "python test.py" only, it means I want the evaluation of the specific model provided in checkpoint argument
    ...
    #parser.add_argument('--save', action='store_true', help="Save the predicted image") # This line for validation
